        ...
        <div className='bg-grey-one h-fit w-full  border-b border-pink-two'>
            <div className='grid md:grid-cols-2 '>
              <div className='text-center md:text-left lg:text-left lg:items-start lg:ml-24 md:ml-20 items-center mx-3 order-2 md:order-1 '>
                  ...
                  <h6 className='text-grey-two font-urbanist text-5xl md:text-4xl lg:text-big lg:py-4 font-normal tracking-normal lg:leading-small mt-4 lg:mt-8'>Elevate Your Beauty, <i className='underline decoration-pink-one md:decoration-8'>Naturally</i></h6>
                ...
                <button className='btn-one mt-5 md:h-10 md:w-40 md:text-xs text-sm h-16 w-44 p-2 mb-3'>EXPLORE OUR SERVICES </button>
              </div>

              {/*hero img */}
              <div  className='flex md:ml-32 order-1 md:order-2 '> 
